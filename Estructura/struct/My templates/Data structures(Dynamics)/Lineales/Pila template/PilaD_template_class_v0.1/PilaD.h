...
class PilaD
{
	...
	public:
		/**
		 *	@brief inicializa la pilaD, asiganando a NULL
		 * 	el tope de la misma
		 *	@since 0.1
		 */
		PilaD(){ tope = NULL; } // inicializa tope de la PilaD
		~PilaD(); // libera recursos asociados con la PilaD
...
/**
 *	@brief libera recursos asociados con la PilaD
 */
template<class T> PilaD<T>::~PilaD(){}
